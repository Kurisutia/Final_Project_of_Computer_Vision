...
def parse_args():
    ...
    parser.add_argument("--test_folder", type=str, default='test_frame/%d.jpg')
    parser.add_argument('--image_folder', type=str, default='out_frame/')
    parser.add_argument('--save_path', type=str, default='test_video/Res.mp4')
...
def video_to_frame(args):
    ...
    count = 0
    while success:
        cv2.imwrite(args.test_folder % count, image)
        success, image = vidcap.read()
